...
// because the subtract() method is incomplete. Fix it!
        int y = subtract(9, 4);
        System.out.println("9 minus 4 equals " + y);
        System.out.println("9 minus 4 equals " + subtract(9, 4));
        int z = subtract(9, 3);
        System.out.println("9 minus 3 equals " + z);
...
// because the multiply() method is incomplete. Fix it!
        int s = multiply(3, 3);
        System.out.println("3 times 3 equals " + s);
        System.out.println("3 times 3 equals " + multiply(3, 3));
        int w = multiply(2, 4);
        System.out.println("2 times 4 equals " + w);
        System.out.println("2 times 4 equals " + multiply(2, 4));
        int v = divide(15, 3);
        System.out.println("15 divided by 3 equals " + v);
        System.out.println("15 divide by 3 equals " + divide(15, 3));
        int u = divide(10, 2);
        System.out.println("10 divided by 2 equals " + u);
